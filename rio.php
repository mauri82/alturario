...
$inicio=strpos($html,'<th data-label="Puerto:">ROSARIO</th>');
$fin=strpos($html,'<th data-label="Puerto:">VILLA CONSTITUCION</th>');
$largo=$fin-$inicio;
...
$respuesta="El río está en ".$altura." metros, ".$estado. " gracias vuelva prontos";
